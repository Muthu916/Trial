...
public class MiniProCont 
{
public static void main(String[] args) throws Throwable
{ 
	System.setProperty("webdriver.chrome.driver", "C:\\Users\\Muthu\\eclipse-workspace\\com.selenium.concepts\\Driver_98\\chromedriver.exe");
	...
	act.moveToElement(driver.findElement(By.xpath("//p[@class='payment_module']"))).click().build().perform();
